...
const spritesheetPattern = "TheSongeryOriginalMusicValentines-{n}.json";
const spritesheetCount = 4;
...
const animationConfig = {
  path: "images/originalMusicRavenValentines",
  spritesheetFiles,
  totalFrames: 948,
  fps: 60,
  loop: false,
...
export const TheSongeryOriginalMusicRavenValentines = (props: IProps) => {
